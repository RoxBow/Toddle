                  ...
                  <table border="0" cellpadding="0" cellspacing="0" class="header" style="border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;width:100%;text-align:center;text-transform:uppercase;margin:0 0 3% 0;font-weight:600;">
                    <tbody>
                      ...
                      <tr>
                        <td style="vertical-align:top;">
                          <button 
                          style="background:#355E7E;padding:2% 3%;font-size:1.4em;font-weight:600;border:none;border-radius:30px;margin:3% 0 0 0;cursor:pointer;"><a href="http://vincentdeplais.fr/toddle/project/classement/" style="text-decoration:none;color:#fff;">CHECK THE RANKING</a></button>
                        </td>
                      </tr>
                    </tbody>
                  </table>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" class="footer" style="border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;width:100%;margin:3% 0;text-align:center;">
                    <tr>
                      <td style="vertical-align:top;">
                        ...
                        <img src="http://vincentdeplais.fr/toddle/projet/img/logo_pompidou.png" alt="pompidou" 
                        style="border:none;-ms-interpolation-mode:bicubic;max-width:100%;display:inline-block;width:20%;vertical-align:middle;">
                      </td>
                    </tr>
                  </table>
